...
def parse_pcb(pcb_path, output_dir):
    ...
    generate_scad_params_file(params, os.path.join(output_dir, 'params.scad'))
    generate_case_scad(os.path.join(output_dir, 'bottom_case.scad'))
    generate_plate_scad(os.path.join(output_dir, 'plate.scad'))
