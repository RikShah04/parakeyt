...
import sys
import os
from casegen.parse_kicad import parse_pcb
from casegen.generate_case import generate_case
...
def build(pcb_path, output_dir):
    os.makedirs(output_dir, exist_ok=True)
    params_path = os.path.join(output_dir, 'params.json')
    parse_pcb(pcb_path, output_dir)
    generate_case(params_path, output_dir)
